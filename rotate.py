...
rotated = generate_rotated_image(img, 15, crop_largest_rect=False)
rotated_2 = generate_rotated_image(img, 15, crop_largest_rect=True)

cv2.imwrite("rotated.jpg", rotated)
cv2.imwrite("rotated_2.jpg", rotated_2)